#this is the dark theme from https://github.com/nik01010/dashboardthemes
#can modify things here.

dark_theme_mod <- shinyDashboardThemeDIY(
  ...
  ,boxPrimaryColor = "rgb(117, 122, 128)" ## box header (G9)
  ...
  ### G9: This is for the selection lists:
  ,textboxBackColor = "rgb(117, 122, 128)"  #the background color
